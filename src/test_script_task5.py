...
class Test(unittest.IsolatedAsyncioTestCase):
    async def test_task5_1(self):
        ...
        try:
            ...
            self.fail("Message was parsed incorrectly")
        msg_dict = parse_msg(msg_str)    
        self.assertEqual(msg_dict['type'], "getmempool")
        ...
        getmempool_msg = {'type':'getmempool'}
        await write_msg(writer, getmempool_msg)
        ...
        try:
            ...
            self.fail("Message was parsed incorrectly")
        msg_dict = parse_msg(msg_str)    
        self.assertEqual(msg_dict['type'], "mempool")
        print(msg_dict['txids'])
